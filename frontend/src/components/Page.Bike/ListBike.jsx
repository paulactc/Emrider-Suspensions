// src/components/Page.Bike/ListBike.jsx
...
function ListBike() {
  ...
  // Si vienes desde UleachCustomUser, puedes haber pasado motos y/o cif en state
  ...
  return (
    <ul className="ulListBikes">
      <UleachBike
        ...
        listTechnical={location.state?.listTechnical} // opcional si lo pasas
      />
    </ul>
  );
}
